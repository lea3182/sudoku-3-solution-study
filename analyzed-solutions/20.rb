...
module Sudoku
  ...
  class Sudoku
    ...
    def initialize(board_string)
      #puts "Loading Sudoku [#{board_string}]"
...
#Sudoku::Runner.new(['set-01_sample.unsolved.txt', 'set-02_project-euler_50-easy-puzzles.txt', 'samples.txt']).run
Sudoku::Runner.new(['set-01_sample.unsolved.txt', 'set-02_project-euler_50-easy-puzzles.txt']).run
# Sudoku::Runner.new('failures.txt').run
# Sudoku::Runner.new('difficult.txt').run
#Sudoku::Runner.new('bugs.txt').run
#Sudoku::Runner.new('samples.txt').run